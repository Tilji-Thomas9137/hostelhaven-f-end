...
const EditStaffModal = ({ isOpen, onClose, staff, onSave, isLoading }) => {
  ...
  useEffect(() => {
    if (staff && isOpen) {
      ...
      setValue('employee_id', staff.employee_id || '');
      setValue('email', staff.email || '');
      setValue('phone', staff.phone || '');
      setValue('role', staff.role || '');
      setValue('status', staff.status || 'active');
    }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className="relative bg-white rounded-3xl shadow-2xl border border-slate-200/60 w-full max-w-2xl max-h-[85vh] overflow-hidden animate-modal-enter">
        {/* Header */}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">Update staff information and settings</p>
              </div>
            </div>
            <button
              onClick={handleClose}
